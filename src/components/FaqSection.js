...
const FaqSection =()=>{
    return(
        <section className="faq_area bg_faq_color sec_pad">
                ...
                <div className="row">
                    <div className="col-lg-4 pr_50">
                        ...
                        <div className="app_img_faq">    
                           <img className="wow fadeIn phone_img" src={require('../img/home7/Message2.png')} alt=""/>
                       </div>
                                    ...
                                    <div className="card">
                                        ...
                                        <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div className="card-body">
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt officiis asperiores voluptatem soluta corrupti culpa accusantium perferendis est ullam hic consequatur, quia vero nostrum unde aliquam laudantium consectetur sit ipsam.
                                            </div>
                                        </div>
                                    </div>
                                    <div className="card">
